class Competition {
  ...
  factory Competition.fromJson(Map<String, dynamic> json) => Competition(
    ...
    competitions: List<CompetitionResult>.from(
      json["competitions"].map((x) => CompetitionResult.fromJson(x)),
    ),
  );
...
class CompetitionResult {
  ...
  factory CompetitionResult.fromJson(Map<String, dynamic> json) =>
      CompetitionResult(
        ...
        name: json["name"] ?? "",
        code: json["code"] ?? "",
        type: typeValues.map[json["type"]] ?? TypeResult.LEAGUE,
        emblem: json["emblem"] ?? "",
        plan: planValues.map[json["plan"]] ?? PlanResult.TIER_ONE,
        currentSeason: CurrentSeasonResult.fromJson(
          json["currentSeason"] ?? {},
        ),
...
class CurrentSeasonResult {
  ...
  factory CurrentSeasonResult.fromJson(Map<String, dynamic> json) =>
      CurrentSeasonResult(
        id: json["id"] ?? 0,
        ...
        currentMatchday: json["currentMatchday"] ?? 1,
        winner: json["winner"] == null
            ? null
            : WinnerResult.fromJson(json["winner"]),
      );
...
enum PlanResult { TIER_FOUR, TIER_ONE }
